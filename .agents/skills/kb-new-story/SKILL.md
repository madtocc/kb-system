---
name: kb-new-story
description: Create a new scoped story in .backlog/stories with the right knowledge-node references and acceptance criteria. Use when the user wants to plan a small piece of work in the KB System. Do not use when the user is asking to implement code immediately without touching the backlog.
---
